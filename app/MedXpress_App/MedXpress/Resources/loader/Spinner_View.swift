...
//  SmartBank
//
//  Created by Mekhriddin Jumaev on 12/06/24.
//
...
fileprivate var loaderViewX: LoaderViewX!
...
extension UIViewController {
    ...
    func dismissLoadingViewX() {
        guard let loaderView = loaderViewX else {
            return
        }
        UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0, options: [], animations: {
...
extension UIViewController {
    ...
    func showLoadingViewX(){
        loaderViewX = LoaderViewX(frame: view.bounds)
        view.addSubview(loaderViewX)
        loaderViewX.alpha = 0
        UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0, options: [], animations: {
             loaderViewX.alpha = 1
         }, completion: nil)
...
class SpinnerViewX : UIView {
    ...
    override func layoutSubviews() {
        super.layoutSubviews()
        layer.fillColor = nil
        layer.strokeColor = UIColor(hex: "2E6FF3").cgColor
        layer.lineWidth = 3.8
        setPath()
    }
...
@IBDesignable
class SpinnerViewVideoX : UIView {
